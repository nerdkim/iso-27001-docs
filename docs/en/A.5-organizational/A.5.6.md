...
- List of special interest groups/security forums/ISACs/associations participated in, and the responsible person designation document
- Proof of membership/subscription and participation history (meeting minutes, newsletter receipt, forum activity records)
- Records showing externally obtained threat/vulnerability information reflected in internal handling (risk assessment/patch/vulnerability remediation)
- Records of review/approval and scope control when sharing information
- History of internal dissemination and response actions after receiving an early warning

## Nonconformity examples

- Participation in special interest groups relies on an individual's informal network, so the contact relationship is severed when that person leaves or is absent.
- External forums/newsletters are only subscribed to, but the threat/vulnerability information obtained is not reflected in risk assessment or patch management at all.
- Internal system configuration/asset details are exposed without review while sharing information with external groups.
- The list of groups and the responsible person designation are not documented, so actual activity cannot be verified.
- An early warning of a new vulnerability is received, but there is no internal dissemination/response procedure, so remediation is delayed.
