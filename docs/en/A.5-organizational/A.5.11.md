...
3. Are unnecessary physical/logical access rights revoked at the effective time of departure or contract termination, or earlier according to risk, regardless of delayed asset return?
...
- Transfer organizational data from BYOD to organizational storage and selectively delete it within authorized procedures and legal authority. Protect personal content and required records, and document deletion results or limitations considering device support and connectivity.
- Revoke accounts, sessions, tokens, and physical access at the effective departure/termination time or earlier according to risk, without waiting for asset return. On role change, remove rights no longer needed; track unreturned assets separately and apply safeguards such as access blocking.
