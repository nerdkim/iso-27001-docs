...
- Review material on legal restrictions relating to the use and import/export of cryptographic technology
- Basis for legal review/action on cross-border data transfers such as transfer of personal data abroad
...
- Foreign business/services are operated without identifying the legal requirements of those jurisdictions or the cross-border data transfer conditions.
- Cryptographic technology is adopted and used without any review of the related legal restrictions (import/export/use regulation).
- Security/privacy requirements stated in contracts are not identified and so do not translate into actual implementation or evidence.
