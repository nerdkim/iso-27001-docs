...
5. Do the procedures cover legal or regulatory notification duties (supervisory authorities, data subjects, and so on), notification deadlines, and external communication criteria?
...
- Designate an incident response owner and a response team (for example, CSIRT), and document roles and responsibilities (RACI), authority, escalation paths, and the emergency contact list, keeping them current.
- Prepare response playbooks and first-action checklists by incident type (malware infection, data breach, denial of service, account compromise, personal data breach, and so on).
...
- Contracts or cooperation arrangements with external specialists (forensics, legal, and so on)
...
- Legal notification duties and deadlines (for example, for personal data breaches) are not reflected in the procedure, creating a risk of delayed notification.
