...
2. Are the defined baselines built into deployment procedures so they are actually applied when systems are newly introduced, reinstalled, or provisioned?
