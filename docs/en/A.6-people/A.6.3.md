...
| ISMS-P mapping | 2.2.4 Awareness and training |
| 2013 mapping | A.7.2.2 |
...
6. Is the effectiveness of awareness and training activities measured (simulation results, incident trends, assessment scores), and are results fed into the next plan?
...
- Record and manage completion status and comprehension, and run remedial procedures such as re-training for those who did not complete.
- Measure effectiveness using simulation results, incident trends, and assessment scores, and feed improvements into the next plan.

## Related controls and attributes

- ISO 27001 clauses: 7.2 (Competence), 7.3 (Awareness), 7.4 (Communication)
- Adjacent Annex A: A.6.1 (Screening), A.6.2 (Terms and conditions of employment), A.6.4 (Disciplinary process), A.5.1 (Policies for information security), A.6.8 (Information security event reporting)
- ISMS-P mapping: 2.2.4 Awareness and training
- 2013 mapping: A.7.2.2 (Information security awareness, education and training)

## Evidence

- Annual information security training/awareness plan and management approval document
- Training content such as course materials, curricula, and slides
- Delivery records: attendance sheets, completion status, online course history
- Role-specific training materials (developers, administrators, personal data handlers) and completion records
- Phishing simulation scenarios and result reports
- Effectiveness measurement materials (assessment results, incident trend analysis, satisfaction surveys) and records of improvements applied

## Nonconformity examples

- A training plan exists, but there are no delivery records or only some personnel completed it, so organization-wide awareness cannot be confirmed.
- New joiners are put to work for a long period without security training and do not know basic security rules.
