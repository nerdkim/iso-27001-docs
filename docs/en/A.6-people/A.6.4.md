...
| Control type (ref.) | Corrective / Preventive |
| Security properties (ref.) | Confidentiality / Integrity / Availability |
| ISMS-P mapping | 2.2.6 Actions on security violations |
| 2013 mapping | A.7.2.3 |

## Control objective

This control requires a formal, previously communicated disciplinary process to be established and applied consistently to employees and other relevant personnel who breach information security policies and rules. When the consequences of a breach are defined in advance and enforced fairly, personnel understand the importance of compliance, which produces a deterrent effect that discourages violations. The control aims to determine the level of action according to the severity, intent, recurrence, and legal implications of the breach, while ensuring that the process is fair and lawful.
...
- Establish a formal disciplinary process that defines applicable actions by type of violation (warning, retraining, revocation of access rights, HR measures) and obtain management approval.
...
- ISO 27001 clauses: 5.3 (Organizational roles, responsibilities and authorities), 7.3 (Awareness), 10.1 (Continual improvement)
- Adjacent Annex A: A.6.2 (Terms and conditions of employment), A.6.3 (Information security awareness, education and training), A.6.5 (Responsibilities after termination or change of employment), A.6.8 (Information security event reporting), A.5.4 (Management responsibilities)
- ISMS-P mapping: 2.2.6 Actions on security violations
- 2013 mapping: A.7.2.3 (Disciplinary process)
...
- There is no documented formal disciplinary process for information security breaches, so cases are handled arbitrarily on an individual basis.
- The disciplinary process is not communicated to personnel in advance, so they are unaware of the consequences of a breach.
- Similar breaches are handled inconsistently because severity, intent, and other factors are not taken into account.
- The process proceeds without fact-finding or giving the individual an opportunity to respond, so fairness/lawfulness is not ensured.
- A clear security breach occurs but the matter is closed with no action or record at all.
- Disciplinary cases are not linked to cause analysis or recurrence-prevention measures, so the same breach keeps recurring.
